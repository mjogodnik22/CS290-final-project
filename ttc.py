...
def TTC(applicant_prefs, company_prefs, capacities, minorities, minority_reserves):
    total_cap = 0
    round_num = 1
    placements = {}
...
ttcRes = TTC(applicant_prefs, employer_prefs, capacities, minorities, minority_reserves)
